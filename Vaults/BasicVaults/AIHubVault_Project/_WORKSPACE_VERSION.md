...
| 202606010001 | R154 — Custom Juggl 추가 (Custom 5→6). community-plugins.json 등록 + plugins/juggl/ 4 파일 복사 + hub-marker description 갱신 + CLAUDE.md 역할 섹션 갱신. 사용자 결정: Juggl 핵심 아닌 Custom 이지만 모든 Preset Hub 에 기본 제공. |
