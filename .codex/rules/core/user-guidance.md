...
상세: `rules-archive/user-guidance-detail.md § 2` + `.agents/rules/custom/CreateVault/vault-individualization.md`
...
상세: `_essentials.md § 4` + `.agents/rules/custom/Distribution/sync-version-priority.md`
